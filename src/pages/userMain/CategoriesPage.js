...
const categoriesInfo = {
    korean: { name: 'KOREAN', image: kFood },
    chinese: { name: 'CHINESE', image: cFood },
    western: { name: 'WESTERN', image: uFood },
    japanese: { name: 'JAPANESE', image: jFood },
    dessert: { name: 'DESSERT', image: dessert },
    cafe: { name: 'CAFE', image: cafe },
    etc: { name: 'ELSE', image: salad },
};
